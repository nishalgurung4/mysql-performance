...
export FILENAME='mysql-shell_8.3.0-1debian10_amd64.deb'
export FILENAME='mysql-shell_8.3.0-1ubuntu20.04_amd64.deb'
export FILENAME='mysql-shell_8.3.0-1debian11_amd64.deb'
